...
class _tamilState extends State<tamil> {
  ...
  List tamil=[
    ...
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_tt0-YNZ2WxpJPOFFY1dy2w-Ayqg0bax6Gw&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzfvXUu-kAun-EFj_9215HeHMvutjKq-LIXw&s",
    "https://assets-in.bmscdn.com/discovery-catalog/events/et00398799-uzwpmnlahw-landscape.jpg",
   "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9yfD3LiBTtUX1cKKuHLTfAo643uYtfOrspA&s",
  ];
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/tamil.jpg",),
                  fit: BoxFit.fill
              ),
            ),
          ),
              ...
              itemBuilder: (Context,index){
                return GestureDetector(
                  onTap: () {
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(builder: (context) => tamil[index]),
                    // );
                  },
                  child: Card(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(tamil[index],),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                  ...
                  child: Card(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        image: DecorationImage(
                          image: NetworkImage(tvshowstamil[index],),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
