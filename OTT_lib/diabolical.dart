...
class diabolical extends StatefulWidget {
  const diabolical({super.key});

  @override
  State<diabolical> createState() => _diabolicalState();
}

class _diabolicalState extends State<diabolical> {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/diabolicall2.jpg"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Text("The Boys Presents: Diabolical",
                style: TextStyle(
                  fontSize: 25,
