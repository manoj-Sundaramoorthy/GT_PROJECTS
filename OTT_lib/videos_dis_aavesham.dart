    ...
    return Scaffold(
      ...
      body:Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image:NetworkImage('https://images.ottplay.com/images/fahadh-faasil-as-ranga-in-aavesham-1713590777.jpg?impolicy=ottplay-20210210&width=350&height=200'),
                fit: BoxFit.fill,
              ),
            ),
          ),
          ...
          Padding(
            padding: const EdgeInsets.only(right: 220,top: 10,bottom: 10),
            child: Text("Aaveshem",
              style: TextStyle(
                fontSize: 25,
          ...
          Padding(
            ...
            child: Text("Three teenagers reach Bangalore for their engineering degree and gets involved in a fight with seniors. They find a local gangster named Ranga to help them take revenge. Three teenagers reach Bangalore for their engineering degree and gets involved in a fight with seniors.",
