      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/peaky2.jpg"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
            ...
            Padding(
              padding: const EdgeInsets.only(right:170,top: 10,bottom: 10),
            ...
            Padding(
              ...
              child: Text("A gangster family epic set in 1900s England, centering on a gang who sew razor blades in the peaks of their caps, and their fierce boss Tommy Shelby. Thomas Shelby and his brothers return to Birmingham after serving in the British Army during WWI.",
            ...
            Padding(
              ...
              child: Text("IMDb 8.8/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
