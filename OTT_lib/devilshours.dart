...
class devilshours extends StatefulWidget {
  const devilshours({super.key});

  @override
  State<devilshours> createState() => _devilshoursState();
}

class _devilshoursState extends State<devilshours> {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/devils2.jpg"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Text("The Devil's Hour is a British psychological thriller that first premiered on October 28, 2022, on Amazon Prime Videos. The series is written by Tom Moran and directed by Johnny Allan. The show centers around Lucy Chambers, portrayed by Jessica Raine, a social worker who wakes up every night at 3:33 am",
